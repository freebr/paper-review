...
<title>导入学院学位评定分委员会修改意见</title>
<% useStylesheet("admin") %>
<% useScript("jquery") %>
</head>
<body bgcolor="ghostwhite">
<center><font size=4><b>导入学院学位评定分委员会修改意见</b><br />
...
<a href="upload/degreeeval_template.xlsx" target="_blank">点击下载学院学位评定分委员会修改意见表格模板</a><br />
...
<body bgcolor="ghostwhite">
<center><br /><b>导入学院学位评定分委员会修改意见</b><br /><br /><%
	If Not bError Then %>
...
<p>文件上传成功，正在导入学院学位评定分委员会修改意见...</p></form>
...
Case 3	' 数据读取，导入到数据库
	...
	If send_email Then
		...
		Dim logtxt:logtxt="行政人员["&Session("name")&"]导入学院学位评定分委员会修改意见。"

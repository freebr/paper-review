...
<% useStylesheet "admin" %>
<% useScript "jquery", "common", "paper", "review", "drafting" %>
</head>
<body>
...
%>
<tr><td align="center" colspan="3" style="padding:0"><p style="font-size:10pt;font-weight:bold"><%=rs("TEACHTYPE_NAME")%>学位论文评价指标</p><table class="form" width="100%" cellspacing=1 cellpadding=3>
...
<tr><td colspan="3"><p>说明：请评审专家在各二级指标得分空格处按百分制打分，系统将自动生成各一级指标得分并最后汇总计算出总分。</p><table class="form" width="100%" cellspacing=1 cellpadding=3>

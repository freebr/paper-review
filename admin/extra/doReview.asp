...
submit_review_date=FormatDateTime(rs("SUBMIT_REVIEW_TIME"),1)
author=rs("STU_NAME")
...
End If
Randomize
filename=FormatDateTime(reviewtime,1)&Int(Timer)&Int(Rnd()*999)
fullfilename=filename&".pdf"
filepath=Server.MapPath("/ThesisReview/expert/export")&"\"&fullfilename
filepath2=Server.MapPath("/ThesisReview/expert/export")&"\"&filename&"_nostu.pdf"
filepath3=Server.MapPath("/ThesisReview/expert/export")&"\"&filename&"_noexp.pdf"

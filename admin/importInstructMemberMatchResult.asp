...
tableUploadPath = Server.MapPath(uploadBasePath(usertypeAdmin, "instruct_member_match_result"))
...
<p><a href="upload/instruct_member_match_result_template.xlsx" target="_blank">点击下载教指委委员匹配结果表格模板</a></p>

...
ElseIf Not checkIfProfileFilledIn() Then
	bError=True
	errMsg="您尚未完善个人信息，<a href=""profile.asp"">请点击这里编辑。</a>"
End If
If bError Then
...
Else
	score_data=Null
End If
bError=rg.exportReviewDocument(review_file_paths(0),review_file_paths(1),review_file_paths(2),template_file,stu_type,Null)=0
Set rg=Nothing
...
ExecNonQuery conn,sql,_
	...
	CmdParam("display_status",adInteger,4,0)

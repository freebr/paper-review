...
<tr height="30">
	...
	<td bgcolor="white" colspan="5"><input type="text" class="txt" name="idcard_no" id="idcard_no" value="<%=HtmlEncode(rs("IDCARD_NO"))%>" /></td>
</tr>
<tr height="30">
	<td bgcolor="gainsboro" align="center">银行账户号</td>
	<td bgcolor="white"><p>
	<input type="text" class="txt" name="bankaccount" id="bankaccount" value="<%=HtmlEncode(rs("BANK_ACCOUNT"))%>" onkeyup="replNoNum(this)" onbeforepaste="replClipboardData('trimNoNum')" />
	</p><p>
	<span class="tip">请填写工行账号</span>
	</p></td>
	<td bgcolor="gainsboro" align="center">开户行</td>
	<td bgcolor="white" colspan="3"><input type="text" class="txt" name="bankname" id="bankname" value="<%=HtmlEncode(rs("BANK_NAME"))%>" /></td>
</tr>
<tr height="30">
	<td bgcolor="gainsboro" align="center">单位名称（含院系）</td>
	<td bgcolor="white" colspan="5"><input type="text" class="txt" name="workplace" id="workplace" value="<%=HtmlEncode(rs("WORKPLACE"))%>" /></td>
</tr>
<tr height="30">
	<td bgcolor="gainsboro" align="center">通信地址（最多25字）</td>
	<td bgcolor="white" colspan="5"><input type="text" class="txt" name="address" id="address" value="<%=HtmlEncode(rs("ADDRESS"))%>" /></td>
</tr>

...
End Select
version="20200814"
template_file=resolvePath("template/doc",version,template_name&".doc")
...
%><!--#include file="template/form_ktbgb.html"--><%
...
%><!--#include file="template/form_ydbyjs.html"--><%
		Case sectionUploadSpclb
			If foreign_student Then
%><!--#include file="template/form_spclb_en.html"--><%
			Else
%><!--#include file="template/form_spclb.html"--><%
			End If
		End Select
	End If %>
</td></tr><%
...
Case 1	' 上传进程
	...
	Case sectionUploadKtbgb
		...
		Set params=getFormParams("activity_id","school_tutor_name","afterschool_tutor_name",_
			"research_field_select","research_field",_
			"sub_research_field_select","sub_research_field","custom_sub_research_field",_
			"study_type","subject","subject_en","thesis_form","is_credential",_
		...
		tg.setField "ThesisForm",params("thesis_form")
		tg.setField "IsCredential",params("is_credential")
	...
	Case sectionUploadZqkhb
		...
		Set params=getFormParams("subject","school_tutor_name","afterschool_tutor_name",_
			"research_field_select","research_field","study_type","accomplished_researches","milestones","work_schedule_duration","work_schedule_content","work_schedule_memo",_
			"following_researches","anticipated_result","difficulties","view_state")

		If stu_type = 5 And Len(params("research_field_select"))=0 Then
			bError=True
			errMsg="请选择工程领域！"
		End If
		If bError Then
		...
		tg.setField "ThesisSubjectCh",params("subject")
		tg.setField "AccomplishedResearches",params("accomplished_researches")
		tg.setField "Milestones",params("milestones")

		tg.setArray "WorkScheduleDuration",params("work_schedule_duration")
		tg.setArray "WorkScheduleContent",params("work_schedule_content")
		tg.setArray "WorkScheduleMemo",params("work_schedule_memo")

		tg.setField "FollowingResearches",params("following_researches")
		tg.setField "AnticipatedResult",params("anticipated_result")
		tg.setField "Difficulties",params("difficulties")

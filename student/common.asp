...
Function getClientInfo(cli)
	...
	Else
		...
		For i=STUCLI_OPR_TABLE1 To STUCLI_OPR_FINAL
			cli.setOpentime i,STUCLI_OPENTIME_START,rs(2*i-1)
			cli.setOpentime i,STUCLI_OPENTIME_END,rs(2*i)
		Next
	End If
	CloseRs rs
	CloseConn conn

...
arrStep=Array("","提交送检和送审论文","导师不同意检测","导师同意检测","论文检测未通过","论文二次检测已通过，等候导师同意送审","导师不同意送审","论文检测已通过，导师同意送审","专家正在评阅","专家完成评阅","导师确认评阅结果","提交答辩论文","答辩论文未通过","答辩论文已通过","答辩委员会给出修改意见","教指会分会给出修改意见","提交定稿论文")
%>